        ...
        for i in [1, 2]:
            for judge in res:
                for team in judge:
                        ...
                        if "criteria" in responseObject[team["team_id"]].keys():
                            if {**criteria, "criteria_score": 0} in [
                                ...
                                if criteria["criteria_id"] in allRes.keys():
                                    ...
                                    allRes[criteria["criteria_id"]]["avg"].append(
                                        responseObject[team["team_id"]]["criteria"][
                                            index
                                        ]["avg"]
                                    )
                    ...
                    if len(avgWeight) > 0:
                        responseObject[team["team_id"]]["total"] = round(
                            (sum(avgWeight) / len(avgWeight)), 2
                        )
                        avgWeight = []
                ...
                responseObject["0"]["total"] = round(
                    (
                        sum(
                            [
                                total["avg"]
                                for total in allRes2[-responseObject["t_criteria"] :]
                            ]
                        )
